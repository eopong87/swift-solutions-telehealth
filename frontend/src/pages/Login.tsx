...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://swift-solutions-alb-1492420054.us-east-1.elb.amazonaws.com/users');
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ margin: 0, color: '#1a1a2e', fontSize: '24px', fontWeight: 'bold' }}>
            Swift Solutions
          </h1>
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', color: '#666', fontSize: '13px' }}>
          Need help? Contact{' '}
          <a href="mailto:support@swiftsolutions.com" style={{ color: '#0066cc' }}>
            support@swiftsolutions.com
          </a>
        </p>
      </div>
    </div>
