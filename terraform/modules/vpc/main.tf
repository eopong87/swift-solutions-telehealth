# Create our own private network in AWS
...
# Public subnets - where your load balancer lives
...
# Private subnets - where your database lives
...
# Internet Gateway - allows traffic in and out of your VPC
